...
export function createServer(apiKey: string): McpServer {
    ...
    server.tool(
        'list_agents',
        'List all available HostLogic AI agent types (Laura, Tamara, Tiffany, Pierre, etc.) with their domain and description.',
        {},
        async () => {
    ...
    server.tool(
        'send_message',
        'Send a text message to the AI receptionist within an existing session. For real-time bidirectional voice use the signed_url from create_session instead.',
        {
    ...
    server.tool(
        'get_usage',
        'Retrieve usage statistics for this API key over the last 30 days. Returns total calls, breakdown by endpoint, and daily call counts.',
        {},
        async () => {
